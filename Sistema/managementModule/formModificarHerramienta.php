...
class formModificarHerramienta{

    public function formModificarHerramientaShow($datos){?>
<!DOCTYPE html>
<html lang="en">
    <head>
...
<br>
    <form action="getHerramientaGSH.php" method="POST">
        <input type="hidden" name="txtId" value="<?=$datos[0]["idherramienta"]?>">
	    <div class="form-group">
            <input class="form-control item" type="text" name="txtNombre" placeholder="Nombre" value="<?=$datos[0]["nombre"]?>">
        </div>
        <div class="form-group">
            <input class="form-control item" type="number" name="nbCantidad" placeholder="Cantidad" value="<?=$datos[0]["cantidad"]?>" min="0">
        </div>
        <div class="form-group">
        <textarea class="form-control item" type="text" name="txtDetalle"  style="WIDTH: 340px; HEIGHT: 98px"  size=32  id="" placeholder="Detalle"><?=$datos[0]["detalle"]?></textarea>
        </div>  
        <div class="form-group">
