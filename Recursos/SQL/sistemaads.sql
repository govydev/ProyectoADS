...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-07-2020 a las 05:56:48
...
(1, 'Personal de Atencion', '', 'fa fa-group'),
...
(60, 'aaaaa', 'aaaaa', 'aaaaa', 'aaaaa', 'aaaaaa', 0);
...
--
ALTER TABLE `herramienta`
  MODIFY `idherramienta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `suministro`
  MODIFY `idsuministro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
